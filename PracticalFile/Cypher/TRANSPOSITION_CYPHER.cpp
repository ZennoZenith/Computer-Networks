...
int main()
{
  ...
  do
  {
    ...
    case 1:
      ...
      cin >> key;
      cin.ignore();
      encryptedText = TranspositionCypher::encrypt(plainText, key, ignoreCharacter);
      cout << "Encrypted text : " << encryptedText << endl;
      cout << "Do you want to decrypt (y/n) : ";
      cin >> flag;
      if (flag == 'y' || flag == 'Y')
        cout << "Plain text : " << TranspositionCypher::decrypt(encryptedText, key, plainText.length(), ignoreCharacter) << "\n\n";
      break;
    case 2:
      ...
      cout << "Plain text : " << TranspositionCypher::decrypt(encryptedText, key, len, ignoreCharacter) << "\n\n";
      break;
    case 3:
